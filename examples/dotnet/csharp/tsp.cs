...
public class TSP {
  class DataProblem {
    ...
    public DataProblem() {
      ...
      int[2] cityBlock = new int[] {228/2, 80};
      foreach (ref int[2] location in locations_) {
        location[0] = location[0] * cityBlock[0];
        location[1] = location[1] * cityBlock[1];
      }
    };

    public int GetVehicleNumber() { return 1;}
    public ref int[,2] GetLocations() { return locations_;}
  ...
  class ManhattanDistance : NodeEvaluator2 {
    ...
    public Manhattan(ref readonly DataProblem data) {
  ...
  static void PrintSolution(
      ref readonly DataProblem data,
      ref readonly RoutingModel routing,
      ref readonly Assignment solution) {
    Console.WriteLine("Objective: {0}", solution.ObjectiveValue());
    // Inspect solution.
    var index = routing.Start(0);
    Console.Write("Route for Vehicle 0:");
    long distance = 0;
    ...
    Console.Write("{0}", routing.IndexToNode(index));
    Console.Write("Distance of the route: {0}m", distance);
  }
  ...
  static void Solve() {
    ...
    NodeEvaluator2 distanceEvaluator = new ManhattanDistance(ref readonly data);
    ...
    PrintSolution(ref readonly data, ref readonly routing, ref readonly solution);
  }
